        ...
        module Html {
            module Client {
                ...
                module Default {
                    module HTML5 {
                        var Tags : {
                            (): __ABBREV.__Client.Html5TagBuilder;
                        };
                        var Attr : {
                            (): __ABBREV.__Client.Html5AttributeBuilder;
                        };
                    }
                    var OnLoad : {
                        (init: {
                ...
                interface AttributeBuilder {
                    ...
                    get_CheckBox(): __ABBREV.__Client.Pagelet;
                    get_Hidden(): __ABBREV.__Client.Pagelet;
                    get_Radio(): __ABBREV.__Client.Pagelet;
                    get_Reset(): __ABBREV.__Client.Pagelet;
                    get_Submit(): __ABBREV.__Client.Pagelet;
                    get_Password(): __ABBREV.__Client.Pagelet;
                    get_TextField(): __ABBREV.__Client.Pagelet;
                }
            }
        }
    }
        ...
        module Bing {
            module Maps {
                module Rest {
                    ...
                    var RequestStringBoilerplate : {
                        (credentials: string): string;
                    };
                    var OptionalFields : {
                        <_M1>(request: _M1, arr: string[]): string[];
                    };
                    var RequestLocationByAddress : {
                        (credentials: string, address: __ABBREV.__Maps.Address, callback: {
                            (x: __ABBREV.__Maps.RestResponse): void;
                        }): void;
                    };
                    var RequestLocationByQuery : {
                        (credentials: string, query: string, callback: {
                            (x: __ABBREV.__Maps.RestResponse): void;
                        }): void;
                    };
                    var RequestLocationByPoint : {
                        (credentials: string, x: number, y: number, entities: __ABBREV.__List.T<string>, callback: {
                            (x: __ABBREV.__Maps.RestResponse): void;
                        }): void;
                    };
                    var StringifyWaypoints : {
                        (waypoints: __ABBREV.__Maps.Waypoint[]): string[];
                    };
                    var RequestRoute : {
                        (credentials: string, request: __ABBREV.__Maps.RouteRequest, callback: {
                            (x: __ABBREV.__Maps.RestResponse): void;
                        }): void;
                    };
                    var RequestRouteFromMajorRoads : {
                        (credentials: string, request: __ABBREV.__Maps.RouteFromMajorRoadsRequest, callback: {
                            (x: __ABBREV.__Maps.RestResponse): void;
                        }): void;
                    };
                    var RequestImageryMetadata : {
                        (credentials: string, request: __ABBREV.__Maps.ImageryMetadataRequest, callback: {
                            (x: __ABBREV.__Maps.RestResponse): void;
                        }): void;
                    };
                    var StaticMapUrl : {
                        (credentials: string, request: __ABBREV.__Maps.StaticMapRequest): string;
                    };
                    var StaticMap : {
                        (credentials: string, request: __ABBREV.__Maps.StaticMapRequest): __ABBREV.__Client.Element;
                    };
                    var credentials : {
                        (): string;
                    };
...
declare module websharper {
    module gasstations {
        module Client {
            ...
            interface LoadPanel {
                Visible: __ABBREV.__Knockout.KnockoutObservable<boolean>;
            }
            interface MapView {
                Map: __ABBREV.__Dom.Element;
                SearchQuery: __ABBREV.__Knockout.KnockoutSubscribable<string>;
                LoadPanel: any;
            }
            var PinClick : {
                (box: __ABBREV.__Maps.Infobox, e: __ABBREV.__Maps.MouseEventArgs): void;
            };
            var InfoClick : {
                (e: __ABBREV.__Maps.MouseEventArgs): void;
            };
            var AddStations : {
                (max: number, map: __ABBREV.__Maps.Map): void;
            };
            var AddressCallback : {
                (map: __ABBREV.__Maps.Map, response: __ABBREV.__Maps.RestResponse): void;
            };
            var SearchAddress : {
                (map: __ABBREV.__Maps.Map, address: string): void;
            };
            var TracingLocation : {
