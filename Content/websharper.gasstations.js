...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Unchecked,Arrays,Bing,Maps,Rest,Strings,document,Html,Default,List,Seq;
 Runtime.Define(Global,{
  IntelliFactory:{
   WebSharper:{
    Bing:{
     Maps:{
      Rest:{
       ...
       {
        document.documentElement.appendChild(Default.Script(List.ofArray([Default.Attr().NewAttr("type","text/javascript"),Default.Attr().NewAttr("src",req)])).Body);
       },
       StaticMap:function(credentials,request)
       {
        return Default.Img(List.ofArray([Default.Attr().NewAttr("src",Rest.StaticMapUrl(credentials,request))]));
       },
...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Concurrency,websharper,gasstations,Client,Stations,Metric,Arrays,Array,Microsoft,IntrinsicFunctionProxy,OperatorIntrinsics,jQuery,Pervasives,List,Strings,Math,Html,Default,Bing,Maps,Rest;
 Runtime.Define(Global,{
  websharper:{
   gasstations:{
    Client:{
     AddStations:function(max,map)
     {
      return Concurrency.Start(Concurrency.Delay(function()
      {
       ...
       return Concurrency.Bind(x,function(arg101)
       {
     ...
     Main:Runtime.Field(function()
     {
      ...
      _MainApp_211_1={};
      _MainApp_211_1.app=new Global.DevExpress.framework.html.HtmlApplication(Pervasives.NewFromList(List.ofArray([["namespace",_MainApp_211_1],["navigationType","simple"]])));
      _app_217_1=_MainApp_211_1.app;
      _MainApp_211_1.Map=function()
      {
      ...
      _app_217_1.router.register(":view",{
       view:"Map"
      });
      return _app_217_1.navigate();
     }),
     Metric:{
     ...
     MkMap:function()
     {
      ...
      map=new Microsoft.Maps.Map(x.Body,options);
      map.setView(view);
