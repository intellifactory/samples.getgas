...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Unchecked,Arrays,Bing,Maps,Rest,Strings,List,Html,Client,Attr,document,Tags,Seq;
 Runtime.Define(Global,{
  WebSharper:{
   Bing:{
    Maps:{
     Rest:{
      ...
      {
       var arg10;
       arg10=List.ofArray([Attr.Attr().NewAttr("type","text/javascript"),Attr.Attr().NewAttr("src",req)]);
       document.documentElement.appendChild(Tags.Tags().NewTag("script",arg10).Dom);
       return;
      },
      StaticMap:function(credentials,request)
      {
       var arg10;
       arg10=List.ofArray([Attr.Attr().NewAttr("src",Rest.StaticMapUrl(credentials,request))]);
 ...
 Runtime.OnInit(function()
 {
  Unchecked=Runtime.Safe(Global.WebSharper.Unchecked);
  Arrays=Runtime.Safe(Global.WebSharper.Arrays);
  Bing=Runtime.Safe(Global.WebSharper.Bing);
...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Concurrency,websharper,gasstations,Client,Stations,Metric,Arrays,Array,Microsoft,Slice,jQuery,JavaScript,Pervasives,List,Strings,Math,Html,Client1,Attr,Tags,Bing,Maps,Rest;
 Runtime.Define(Global,{
  websharper:{
   gasstations:{
    Client:{
     ...
     {
      var coords;
      coords=Arrays.get(Arrays.get(response.resourceSets,0).resources,0).point.coordinates;
      return map.setView({
       center:new Microsoft.Maps.Location(Arrays.get(coords,0),Arrays.get(coords,1)),
       zoom:12
      });
     },
     Array:{
      take:function(n,arr)
      {
       return n<=Arrays.length(arr)?Slice.array(arr,{
        $:1,
        $0:0
       },{
        $:1,
     ...
     {
      var _MainApp_212_1,_app_218_1;
      Global.ko.bindingHandlers.element={
       update:function(element,valueAccessor)
       {
        var x;
        x=Global.ko.unwrap(valueAccessor(null));
        jQuery(element).empty();
        return jQuery(element).append(x);
       }
      };
      _MainApp_212_1={};
      _MainApp_212_1.app=new Global.DevExpress.framework.html.HtmlApplication(Pervasives.NewFromList(List.ofArray([["namespace",_MainApp_212_1],["navigationType","simple"]])));
      _app_218_1=_MainApp_212_1.app;
      _MainApp_212_1.Map=Runtime.CreateFuncWithArgs(function()
      {
       ...
       {
        return!Strings.IsNullOrEmpty(Strings.Trim(value))?Client.SearchAddress(map,value):null;
       });
       return viewModel;
      });
      _app_218_1.router.register(":view",{
       view:"Map"
      });
      return _app_218_1.navigate();
     }),
     Metric:{
     ...
     MkMap:function()
     {
      var arg10,x,options,view,map;
      arg10=List.ofArray([Attr.Attr().NewAttr("class","dx-map-container")]);
     ...
     Stations:{
      ...
      FetchStations:function()
      {
       ...
       return Concurrency.FromContinuations(function(tupledArg)
       {
        var ok,self;
        ok=tupledArg[0];
        self=jQuery.getJSON(url);
        self.done.apply(self,[function(data)
        {
         var _;
      ...
      {
       return(Stations.fetched())()?Concurrency.Delay(function()
       {
        return Concurrency.Return(Stations.Cache());
