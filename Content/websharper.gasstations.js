...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Concurrency,websharper,gasstations,Client,Stations,Metric,Arrays,Array,Microsoft,IntrinsicFunctionProxy,OperatorIntrinsics,jQuery,Pervasives,List,Strings,Math,Html,Default,T,Bing,Maps,Rest;
 Runtime.Define(Global,{
  websharper:{
   gasstations:{
    Client:{
